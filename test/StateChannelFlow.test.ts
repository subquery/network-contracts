...
describe('StateChannel Workflow Tests', () => {
    ...
    it('state channel workflow test', async () => {
        ...
        const channelId4 = ethers.utils.randomBytes(32);
        await openChannel(channelId, indexer, consumer, etherParse('10'), etherParse('1'), 300);
        await openChannel(channelId2, indexer, consumer2, etherParse('15'), etherParse('1'), 30);
        await openChannel(channelId3, indexer2, consumer, etherParse('5'), etherParse('1'), 30);
        await openChannel(channelId4, indexer2, consumer2, etherParse('8'), etherParse('1'), 100);
        ...
        expect(await token.balanceOf(stateChannel.address)).to.equal(etherParse('34'));
        ...
        expect(await token.balanceOf(stateChannel.address)).to.equal(etherParse('29'));
